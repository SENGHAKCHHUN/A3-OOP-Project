...
// bookings //
let booking1 = new booking("$150", p1, "C1", khmer, uk);
let booking2 = new booking("$222", p2, "C100", khmer, us);
let booking3 = new booking("$120", p3, "C301", khmer, bakang);
...
let flight1 = new flight("GR-HU32", "", khmer, uk, date1, date2, manager1);
